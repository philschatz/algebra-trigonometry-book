...
<div data-type="media" data-alt="A polynomial reading: a sub n times x to the nth power plus and so on plus a sub 2 times x squared plus a sub one times x plus a subzero is shown. The a in the term a sub n is labeled: leading coefficient. The n in the term x to the nth power is labeled: degree. Finally, the entire term is labeled as: Leading term.">
...
[1]: http://openstaxcollege.org/l/addsubpoly
[2]: http://openstaxcollege.org/l/multiplpoly
[3]: http://openstaxcollege.org/l/specialpolyprod
