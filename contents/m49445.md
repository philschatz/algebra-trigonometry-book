...
The values of the truck in the example are said to form an **arithmetic sequence** because they change by a constant amount each year. Each term increases or decreases by the same constant value called the **common difference** of the sequence. For this sequence, the common difference is –3,400.
 ...
 <span data-type="media" data-alt="A sequence {3, 6, 9, 12, 15, ...} that shows the terms only differ by 3." data-display="block"> ![A sequence \{3, 6, 9, 12, 15, ...} that shows the terms only differ by 3.](../resources/CNX_Precalc_Figure_11_02_002.jpg) </span><div data-type="note" data-label="A General Note" markdown="1">
<div data-type="title">
Arithmetic Sequence
</div>
